...
import { AFTER_TOUR, ALERTS_TOUR, APPROVALS_TOUR, CONSOLE_TOUR, DISPATCH_TOUR, FEEDS_TOUR, HOW_TOUR, INCIDENTS_TOUR, QUANTUM_TOUR, REPORTS_TOUR, RESOURCES_TOUR } from "@/routes/admin/tours"
...
const ADMIN: { path: string; key: string; el: ReactNode; steps: TourStep[] }[] = [
  { path: "console", key: "console", el: <Console />, steps: [CLOCK_STEP, ...CONSOLE_TOUR] },
